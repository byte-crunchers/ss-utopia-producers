...
class TestClass(unittest.TestCase):
    ...
    def test_count_clear_add(self):
        conn_count_clear_add = connect_mysql()
        clear_table("users", conn_count_clear_add)  # Clear the table
        ...
        clear_table("users", conn_count_clear_add)  # Clear the table again
        self.assertEqual(count_rows("users"), 0)  # Test that count is 0 again
        conn_count_clear_add.close()
    ...
    def test_user_producer_small(self):
        ...
        clear_table("users", conn_small)  # Clear table
        ...
        clear_table("users", conn_small)  # Clear the table
        self.assertEqual(count_rows("users"), 0)  # Test that table is empty
        conn_small.close()
    ...
    def test_user_producer_large(self):
        ...
        clear_table("users", conn_large)  # Clear table
        self.assertEqual(count_rows("users"), 0)  # Test that table is empty
        ...
        clear_table("users", conn_large)  # Clear the table
        self.assertEqual(count_rows("users"), 0)  # Test that table is empty
        conn_large.close()
    ...
    def test_user_producer_stress(self):
        ...
        clear_table("users", conn_stress)  # Clear the table
        self.assertEqual(count_rows("users"), 0)  # Test that table is empty
        conn_stress.close()
